...
class modelSettings(dict):
	...
	def __init__(self):
		...
		self['Overhang angle'] = setting(value=0,	lower=5,	upper=80,	unit='°')
		self['Spacing X'] = setting(value=0,	lower=0,	upper=359,	unit='mm')
		self['Spacing Y'] = setting(value=0,	lower=0,	upper=359,	unit='mm')
		self['Maximum height'] = setting(value=0,	lower=1,	upper=1000,	unit='mm')
