...
class programSettings(dict):	
	...
	def __init__(self, console=None):
		...
		self['MCU'] = setting(value='atmega32u4')
		self['Programmer'] = setting(value='avr109')
		self['Port'] = setting(value='/dev/ttyACM0')
		self['Baud'] = setting(value='57600')
		self['Options'] = setting(value='-D -V')
		self['Firmware path'] = setting(value='./firmware/main.hex')
